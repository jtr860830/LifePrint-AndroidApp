...
public class Http_AccountPost extends Service {
    ...
    public void Post(String strname,String strbir,String strpas,String stremail, final String Url){
        username=strname;
        birthday=strbir;
        password=strpas;
        email=stremail;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if(httpResponse.getStatusLine().getStatusCode() == 200){
                    ...
                    CreateAccount.handler.sendMessage(msg);
                }
            }}).start();
